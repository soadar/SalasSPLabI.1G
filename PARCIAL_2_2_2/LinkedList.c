...
/** \brief filtra de acuerdo a la funcion criterio recibida como parametro
 * \param this LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
...
/** \brief suma la candtidad de datos que le va indicando la funcion criterio recibida como parametro
 * \param this LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return cont la cantidad de datos de acuerdo a la funcion recibida, -1 en caso de error
 */
